...
{
    /// <inheritdoc />
    public partial class intetialcreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoneyOwed = table.Column<decimal>(type: "decimal(18,2)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Purchase_Merchant_MerchantId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "25b45179-1692-49a7-9687-bc4d71f64597", "3", "ServiceProvider", "ServiceProvider" },
                    { "301c0cb4-85a1-4a5a-bc35-d08ea98e0e2c", "1", "User", "User" },
                    { "4e3a65e7-3908-43d9-838f-a4969fedd2c1", "2", "BussinesOwner", "BussinesOwner" },
                    { "b16cefa7-1ad5-487b-8e99-8e3093ba81ed", "4", "Admin", "Admin" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product_UniqueNumber",
                table: "Product",
                column: "UniqueNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Purchase_MerchantId",
                table: "Purchase",
                column: "MerchantId");
